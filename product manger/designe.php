    ...
    <div class="main-panel">
        ...
        <div class="col-md-6 col-sm-2 col-lg-5">
            ...
            <div class="bg-dark p-3 rounded text-white">
                ...
                <input type="checkbox" class="form-check rounded-circle" style="width: 50px; height: 50px; " name="color[]" id="">
            </div>
        </div>
        <div class="col-md-6 col-sm-8 col-lg-7 " style="height: 800px;">
            <div class="bg-dark text-white p-3 rounded">
                ...
                <div class="canvas-section" style="background-image: url('../assets/img/product/blackshirt-back.png');">
