                    ...
                    <div class="row">
                        ...
                        <nav class="navbar-dark bg-dark">
                            <div  class="container-fluid" style="display: none;" id="<?php echo $rowside['Sides']?>text-propetys">
                                <div class="input-group">
                                    <input type="number"  name="" id="<?php echo $rowside['Sides']?>text_Pos_X">
                                    <input type="number"  name="" id="<?php echo $rowside['Sides']?>text_Pos_Y">
                                    <label for="font-size">Font Size:</label>
                                    <input class="my-2 form-control" type="number" id="<?php echo $rowside['Sides']?>font-size" min="1" value="16">
                                    <label for="font-family">Font Family:</label>
                                    <select class="my-2 form-control" id="<?php echo $rowside['Sides']?>font-family">
                                    ...
                                    <select class="my-2 form-select" id="<?php echo $rowside['Sides']?>text-style">
                                        <option value="normal">Normal</option>
                                        <option value="italic">Italic</option>
                                        <option value="oblique">Oblique</option>
                                    </select>
                                    <label for="text-decoration">Text Decoration:</label>
                                    <select class="my-2 form-select" id="<?php echo $rowside['Sides']?>text-decoration">
                                    ...
                                    <input class="my-2 form-color" type="color" id="<?php echo $rowside['Sides']?>text-color">
                                    <br>
                                    <label for="text-alignment">Text Alignment:</label>
                                    <select class="my-2 form-select" id="<?php echo $rowside['Sides']?>text-alignment">
                        ...
                        <div class="col-md-6 col-sm-2 col-lg-5">
                            <div class="bg-dark p-3 rounded text-white">
                                <textarea class="my-2 form-control" id="<?php echo $rowside['Sides']?>text-input" placeholder="Enter text"></textarea>

                                <form id="<?php echo $rowside['Sides']?>image-form" enctype="multipart/form-data">
                                    <label for="<?php echo $rowside['Sides']?>image-input">Upload Image:</label>
                                    <input class="my-2 form-control" type="file" id="<?php echo $rowside['Sides']?>image-input" accept="image/*">
                                </form>
                        ...
                        <div class="col-md-6 col-sm-8 col-lg-7">
                            ...
                            <div class="bg-dark d-block p-3 text-white" style="height: 200px important;" >
                                <div id="<?php echo $rowside['Sides']?>img-property" style="display: none;" >
                                    ...
                                    <input class="my-2 form-range" type="range" id="<?php echo $rowside['Sides']?>image-size" min="50" max="140" step="1" value="200">
                                    <!-- Rotation input for the image -->
                                    <label for="image-rotation">Image Rotation:</label>
                                    <input class="my-2 form-range" type="range" id="<?php echo $rowside['Sides']?>image-rotation" min="0" max="360" step="1" value="0">
                                    <input type="number"  name="" id="<?php echo $rowside['Sides']?>Img_Pos_X">
                                    <input type="number"  name="" id="<?php echo $rowside['Sides']?>Img_Pos_Y">
                                </div>
                            </div>
                        </div>
                        <script>
